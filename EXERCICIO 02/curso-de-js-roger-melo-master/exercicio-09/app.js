...
*/
const gatString = string =>string.length
    console.log(gatString('oi'))
...
*/
  const toLowCaseString = string => string.toLowerCase()
    console.log(toLowCaseString ( "CHOCOTONE E OVO DE PÁSCOA JUNTOS NO MERCADO EM PLENO FEVEREIRO"))
/*
  04
...
*/
  const isItemCloud = (item,array)=> array.includes(item)
    console.log(isItemCloud(3,[3,4,1]))
/*
  06
...
console.log(removeListItem([1,2,3]))
/*
  08
  ...
  - Crie uma função que retorna se o valor passado como argumento em sua  
    invocação é null.
*/
  const insNull = value => value === null
     console.log(insNull(null))
/*
  09
