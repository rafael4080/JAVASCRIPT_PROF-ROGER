...
*/
 //document.write('Grandes poderes trazem grandes responsabilidades.')
...
*/
 ...
 //document.write(myFavoriteTom)
 //document.write(`${tom} ${firsTom}`)
...
*/
  ...
  const js = progammingLanguage[0] + progammingLanguage[4]
  //document.write(js)
...
*/
  const comprimento = progammingLanguage.length + " caracteres."
...
let randomWord = 'Carme'
//document.write(randomWord[randomWord.length - 1])
...
//document.write(summerMessage.toLowerCase())
...
const winterMessage = 'o inverno está chegando'
 //document.write(winterMessage.toUpperCase())
/*
11 - Comente o console.log acima, e,

- Exiba, no console, o index do caractere "v" da "winterMessage";
*/
 const indexArm = winterMessage.indexOf('v')
 //document.write(indexArm)
...
*/
  const lastwinsterMessage = winterMessage.lastIndexOf('n')
  //document.write(lastwinsterMessage)
...
//document.write(harryPotterAuthor.slice(0,3))
...
const realBastMovie = 'E o Oscar de melhor filme vai para: "moolight"!'
//document.write(realBastMovie)
...
let newName = names[0].toUpperCase() + names.slice(1,6) + ' ' + names[7].toUpperCase() + names.slice(8)
...
- Exiba a "newName" no console;
*/
newName = `${names[0].toUpperCase()}${ names.slice(1,6)} ${names[7].toUpperCase()}${names.slice(8)}`
console.log(newName)